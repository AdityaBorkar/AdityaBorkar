...
export default function IntegrationsGPT() {
	return (
		<section className="py-[50px]">
			<div className="mx-auto grid child:h-full h-[60vh] w-[70vw] grid-cols-[60%_40%] gap-12 child:bg-neutral-900">
				<Input />
				<Output />
			</div>
		</section>
...
function Output() {
	...
	return (
		<div className="relative rounded-xl p-10">
			<div className="absolute top-0 left-0 flex w-full flex-row justify-between border-neutral-800 border-b px-4 py-3">
				<div className="pt-0.5 font-medium text-neutral-100">
					<HiCodeBracketSquare className="mr-1 ml-2 inline align-[-5px] text-2xl text-neutral-300" />
					IntegrationsGPT
				</div>
				<div className="rounded border border-neutral-700 px-2 py-1 font-medium text-neutral-500 text-sm">
			...
			{response ? (
				...
				<>
					<div className="mt-10 child:mb-4 text-neutral-200 leading-relaxed">
						<p>
					...
					<div className="mt-6 flex flex-row justify-between">
						<button className="w-fit rounded-md border border-neutral-700 bg-neutral-800 px-3 py-1.5 text-neutral-300 text-sm transition-all hover:scale-[0.98] active:scale-90">
							<HiOutlineArrowPath className="mr-1 inline align-[-2px]" />
							Regenerate Idea
						</button>
						<ScheduleMeetBtn className="w-fit rounded-md border border-neutral-700 bg-neutral-800 px-3 py-1.5 text-neutral-300 text-sm transition-all hover:scale-[0.98] active:scale-90">
