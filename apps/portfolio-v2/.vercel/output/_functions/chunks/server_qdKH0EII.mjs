import { z } from 'zod';
import { a as apiContextRoutesSymbol, b as shouldAppendForwardSlash, A as ACTION_API_CONTEXT_SYMBOL, h as hasContentType, f as formContentTypes, i as isActionAPIContext } from './index_CvEo418X.mjs';
import { A as AstroError, f as ActionNotFoundError, g as ActionCalledFromServerError } from './astro/server_BO6KBylT.mjs';
import { r as removeTrailingForwardSlash } from './path_DQHtp1ua.mjs';
import { A as ActionError, s as serializeActionResult, d as deserializeActionResult, a as ACTION_RPC_ROUTE_PATTERN, b as ACTION_QUERY_PARAMS, c as callSafely, e as ActionInputError } from './astro-designed-error-pages_D_kXHF0P.mjs';

async function getAction(path) {
  const pathKeys = path.split(".").map((key) => decodeURIComponent(key));
  let { server: actionLookup } = await import('./_astro_internal-actions_CQBq3TVc.mjs');
