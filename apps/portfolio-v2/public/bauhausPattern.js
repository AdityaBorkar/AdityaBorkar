    ...
    class BauhausPattern {
        ...
        paint(ctx, geometry, properties) {
            ...
            const patternSize = parseInt(properties.get("--pattern-size").toString()) || 1024;
            const patternDetail = parseInt(properties.get("--pattern-detail").toString()) || 16;
            const seed = parseInt(properties.get("--pattern-seed").toString()) || 1000;
