...
export default function AboutPage() {
  return (
    <main className="mx-auto w-[80vw] max-w-[48rem] py-20">
      ...
      <figure
        className={cn(
          'mx-auto mt-8 grid h-[50vw] w-full gap-4 bg-red-300 md:max-h-[12rem]',
  ...
  return (
    <div className={cn(props.className)}>
      <img
        src={props.src}
        alt={props.alt || ''}
        className="h-full w-full cursor-pointer rounded-3xl border border-bg-secondary object-cover hover:scale-105 hover:shadow-xl hover:shadow-zinc-300/50"
      />
    </div>
  )
}
